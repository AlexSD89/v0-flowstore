...
### 3.1. Agents (`/Users/dangsiyuan/.claude/AGENT/`)
...
- **For IDEs**: Users interact with the agents directly via their markdown files in `/Users/dangsiyuan/.claude/AGENT/`. The IDE integration (for Cursor, Claude Code, etc.) knows how to call these agents.
