...
description: LaunchX Guardrailed Codex CLI integration for Claude Code. Ensures approval-aware command construction, minimal permissions, and verification logging.
allowed-tools:
  - bash:read-only
  - python:read-only
  - read
...
related:
  - ./README.md
source: 人工采集
impact: 规范 Codex CLI 在 Claude Code 场景下的调用流程与风险管理
tags:
  - codex
  - guardrails
---
