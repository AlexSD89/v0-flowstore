...
export default function ProvidersPage() {
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Clear Contact CTA Section */}
      <section className="py-20">
        <div className="container mx-auto px-4">
          <Card className="max-w-4xl mx-auto p-12 bg-accent/5 border-accent/20">
            <div className="text-center">
              <h2 className="text-3xl font-bold mb-4">立即联系我们</h2>
              <p className="text-lg text-neutral-600 mb-8 max-w-2xl mx-auto">
                无论您是AI公司、开源项目还是独立开发者，我们都欢迎您加入Gate生态。填写表单或发送邮件至 <a href="mailto:partners@gate.ai" className="text-accent hover:underline">partners@gate.ai</a>
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button size="lg" className="h-12 px-8" asChild>
                  <a href="/contact?type=provider">
                    <Users className="w-5 h-5 mr-2" />
                    提交入驻申请
                  </a>
                </Button>
                <Button size="lg" variant="outline" className="h-12 px-8 bg-transparent" asChild>
                  <a href="mailto:partners@gate.ai">
                    发送邮件咨询
                  </a>
                </Button>
              </div>
