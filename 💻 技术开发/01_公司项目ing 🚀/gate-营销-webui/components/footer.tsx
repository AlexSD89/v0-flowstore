        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-8 mb-8">
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li>
                <a href="/solutions/ai-sdr" className="hover:text-foreground transition-colors">
                  AI SDR 智能获客
                </a>
              </li>
              <li>
                <a href="/solutions/lead-management" className="hover:text-foreground transition-colors">
                  销售线索管理
                </a>
              </li>
              <li>
