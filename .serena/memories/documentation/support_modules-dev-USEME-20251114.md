---
title: "Support Modules Dev Useme 20251114"
owners: 
  - "LaunchX Memory Team"
status: active
...
**📂 原始分类**: support_modules/dev
**🏷️ 原始标签**: support_module, dev
**🤖 智能标签**: 结构化内容, 标准格式, AI协作, 规范文档, 工具库, 可复用组件, MCP服务, LaunchX, 通用模块
**📄 内容类型**: structured
**📁 原始路径**: support_modules/dev/USEME.md
...
### 📚 关联知识
- 与`support_modules/dev`分类下的其他知识自动关联
- 与`structured`类型内容建立智能链接
- 基于标签`结构化内容, 标准格式, dev, AI协作, support_module, 规范文档, 工具库, 可复用组件, MCP服务, LaunchX, 通用模块`构建知识网络
