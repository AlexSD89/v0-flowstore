...
版本：2025-10-12 · 维护：LaunchX Tech Core

> 面向 `💻 技术开发/` 及其共用脚本、工具链与自动化资产。所有开发域任务都应先查阅本指南，确认现成能力与 guardrails，再进入 `/spec → /plan → /do`。

## Phase 0 Checklist
```text
[ ] 阅读根级 CLAUDE.md / AGENTS.md 与 💻 技术开发 域内 README / CLAUDE / RULES / AGENTS
